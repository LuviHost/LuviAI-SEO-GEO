...
export class AiCitationService {
  ...
  async classifyRealCompetitors(opts: {
    ...
    const system = [
      ...
      '',
      'Gercek rakip = marka ile HEM AYNI TURDE HEM AYNI KONUDA/DIKEYDE hizmet veren site.',
      'Iki kosul birlikte saglanmali; biri eksikse RAKIP DEGILDIR.',
      '',
      '1) IS MODELI ayni olmali:',
      '   - Marka bir KARSILASTIRMA/ARACILIK platformuysa, karsilastirdigi',
      '     SAGLAYICILAR (bankalar, magazalar, markalar) rakip DEGILDIR.',
      '   - Bir dijital banka veya finans kurumu, karsilastirma platformunun',
      '     rakibi DEGILDIR (o bir saglayicidir).',
      '',
      '2) KONU/DIKEY ayni olmali — EN SIK YAPILAN HATA BUDUR:',
      '   - Marka hangi ALANDA karsilastirma yapiyorsa, rakip de AYNI ALANDA',
      '     karsilastirmali. Farkli alanda karsilastirma yapan site, karsilastirma',
      '     platformu OLSA BILE rakip DEGILDIR.',
      '   - Ornek: marka FINANSAL URUN (kredi, POS, ticari kart) karsilastiriyorsa;',
      '     URUN fiyati karsilastiran (cimri gibi), SEYAHAT/ucak bileti karsilastiran',
      '     (enuygun gibi) siteler FARKLI DIKEYDEDIR → rakip DEGILDIR.',
      '   - Markanin alani genis olabilir (birden fazla urun tipi). Rakip, bu',
      '     alanlardan EN AZ BIRINDE ayni tur karsilastirmayi yapan sitedir.',
      '',
      'Resmi kurumlar, federasyonlar, devlet siteleri, haber/ansiklopedi/jenerik',
      'kaynak siteler her durumda RAKIP DEGILDIR.',
      '',
      `Bu markanin konusu: ${nicheDesc}.`,
      'NOT: Bu konu ozeti otomatik uretildi ve DAR olabilir. Marka sitesinin adi ve',
      'baglamindan daha genis bir kapsami varsa (orn. yalniz kredi degil; POS, kart,',
      'sigorta gibi baska finansal urunler de) onu da dikkate al. Ama alan yine',
      'FINANSAL kalir — baska sektorlere (seyahat, urun fiyati) genisleme.',
      '',
