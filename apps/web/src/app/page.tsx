...
function PriceCard({
  ...
  return (
    <div className={`relative p-7 rounded-2xl border flex flex-col ${
      ...
      {highlighted && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-gradient-to-br from-orange-500 to-orange-600 text-white shadow-lg">
