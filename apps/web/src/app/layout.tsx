...
const orgJsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      featureList: [
        'AI site denetimi (SEO + GEO + 14 kontrol)',
        'AI makale üretimi (1800-2500 kelime, 6 ajanlı zincir)',
        'WordPress, Webflow, Shopify, Ghost, FTP/SFTP, GitHub otomatik yayın',
        '7 kanal sosyal medya planlayıcı (LinkedIn, X, Instagram, TikTok, Facebook, YouTube Shorts, Threads)',
        'Apple Search Ads (ASA) — kampanya yönetimi + Auto-Pilot',
        'App Store Connect (ASC) — review + release takibi',
        'AI Studio — DALL-E 3, GPT Image, Sora 2, Veo 3, Runway, HeyGen',
        'Stuck Page Recovery — Google #4-#15 takılı sayfaları AI ile düzeltme',
        'Google Ads + Meta Ads kampanya denetimi',
        'AI crawler trafiği takibi (GPTBot, ClaudeBot, PerplexityBot, ChatGPT-User)',
        'AI Citation tracking (ChatGPT, Claude, Gemini, Perplexity, Grok, DeepSeek)',
        'Spend Cap (Cost Guard) + Video Credit Add-on',
      ],
