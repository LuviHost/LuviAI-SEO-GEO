  ...
  return (
    <main className="relative">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Link href="/" className="text-sm text-muted-foreground hover:text-brand dark:hover:text-brand-400 transition-colors">← Ana sayfa</Link>
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              <a href="mailto:kvkk@luvihost.com" className="text-brand dark:text-brand-400">kvkk@luvihost.com</a>
            </p>
          </section>
