    ...
    <div className="relative">
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="font-brandDisplay text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight mb-4">
            Sistem{' '}
        ...
        <p className="text-xs text-muted-foreground text-center mt-8">
          ...
          <a href="https://stats.uptimerobot.com/luviai" className="text-brand dark:text-brand-400 hover:underline" target="_blank" rel="noopener">
