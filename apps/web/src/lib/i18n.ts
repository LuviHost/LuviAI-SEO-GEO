...
const dictionary = {
  tr: {
    ...
    'land.sol.c3.tag': 'SOSYAL MEDYA STUDIO',
    'land.sol.c3.title': 'AI ile post, görsel, video üret',
    'land.sol.c3.body': 'Tek konudan X / LinkedIn / Instagram için 3 farklı varyant. Sora 2, Google Veo 3, Runway ile video; DALL-E ile görsel.',
    'land.sol.c3.b1': 'Görsel: GPT Image / DALL-E',
    'land.sol.c3.b2': 'Video: Sora 2 + Veo 3 + Runway',
    'land.sol.c3.b3': 'Metin: GPT-5 / Claude 4',
    'land.sol.c3.b4': 'Çoklu kanal tek tık paylaşım',
    ...
    'land.cmp.row5': 'Sosyal medya post + zamanlama',
    'land.cmp.row6': 'AI görsel + video üretimi',
  ...
  en: {
    ...
    'land.sol.c3.tag': 'SOCIAL MEDIA STUDIO',
    'land.sol.c3.title': 'Generate posts, images, videos with AI',
    'land.sol.c3.body': 'From a single topic, 3 variants for X / LinkedIn / Instagram. Videos with Sora 2, Google Veo 3, Runway; images with DALL-E.',
    'land.sol.c3.b1': 'Images: GPT Image / DALL-E',
    'land.sol.c3.b2': 'Video: Sora 2 + Veo 3 + Runway',
    'land.sol.c3.b3': 'Text: GPT-5 / Claude 4',
    'land.sol.c3.b4': 'Multi-channel one-click sharing',
    ...
    'land.cmp.row5': 'Social media post + scheduling',
    'land.cmp.row6': 'AI image + video generation',
    ...
    'land.pric.bullet_posts': 'social posts / mo',
    'land.pric.bullet_site': 'site',
    'land.pric.bullet_sites': 'sites',
    'land.pric.bullet_support': 'Support:',
    'land.pric.cta_free': 'Start free',
